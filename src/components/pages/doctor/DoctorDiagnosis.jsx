...
import { Activity, FileText, AlertTriangle, Stethoscope, Microscope, User, Loader2 } from 'lucide-react';
...
export default function DoctorDiagnosis() {
    ...
    // Đã thêm optional chaining `?.` để tránh lỗi khi record đang load (bằng null)
                                ...
                                {lab ? (
                                    <>
                                        ...
                                        <div className="mb-6 rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-transparent p-5 shadow-sm">
                                            ...
                                            {/* Giao diện hiển thị aiNote cuộn được */}
                                            {aiNote && (
