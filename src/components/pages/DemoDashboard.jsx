...
import {
  Activity, Bell, Calendar, ChevronRight, Heart,
  LogOut, Pill, Search, Shield, TrendingUp, User, Wallet,
} from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          background: '#F1F5F9', borderRadius: 10, padding: '8px 16px',
          width: 280,
        }}>
          <Search style={{ width: 16, height: 16, color: '#94A3B8' }} />
          <input
            placeholder="Tìm hồ sơ, bác sĩ..."
            style={{ background: 'transparent', border: 'none', outline: 'none', fontSize: 14, color: '#475569', width: '100%' }}
          />
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 14, fontWeight: 600, color: '#0F172A', lineHeight: 1.2 }}>{displayName}</div>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                  ...
                  <p style={{ fontSize: 32, fontWeight: 800, color: '#0F172A', margin: '6px 0 4px' }}>{s.value}</p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button style={{
                ...
                fontSize: 13, color: '#3B82F6', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 2,
              }}>
