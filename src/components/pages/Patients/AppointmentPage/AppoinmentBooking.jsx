                ...
                <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-6 md:gap-8">
                                        ...
                                        <div className="text-center">
                                            <div
                                                className={`text-xs font-semibold mb-1 ${
                                                    selectedDate === date.index ? 'text-[#0d7b6d]' : 'text-gray-500'
                                                }`}
                                            >
                                                {date.dayName}
                                            </div>
                                            <div
                                                className={`text-lg sm:text-xl md:text-2xl font-bold ${
                                                    selectedDate === date.index ? 'text-[#0d7b6d]' : 'text-gray-900'
                                                }`}
                                            >
                                                {date.day}
                                            </div>
                  ...
                  `}
                                        ...
                                        <div className="flex-1 text-left">
                                            <div
                                                className={`font-bold ${
                                                    selectedService === service._id ? 'text-[#0d7b6d]' : 'text-gray-900'
                                                }`}
                                            >
                                                {service.name}
                                            </div>
