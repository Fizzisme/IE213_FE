                            ...
                            <div className="bg-primary p-10 flex flex-col justify-center text-white">
                                ...
                                <div>
                                    ...
                                    <p className="opacity-80 mb-8">
                                        Lưu trữ hồ sơ y tế của bạn một cách an toàn. Thông tin của bạn được mã hóa và
                                        bảo vệ theo các quy định về bảo mật y tế.
                                    </p>
                            ...
                            <div className="p-12">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-white cursor-pointer bg-primary font-semibold py-3 px-8 rounded-lg transition-colors ${
                                            isSubmitting
                                                ? 'bg-green-400 cursor-not-allowed'
                                                : 'bg-green-600 hover:bg-primary/80'
                                        }`}
                                    >
