export default function WelcomeBanner({ displayName, roleLabel, loginMethod }) {
    return (
        <div
            className="min-h-32 md:min-h-40 relative mb-5 md:mb-7 overflow-hidden rounded-2xl bg-gradient-to-br from-teal-700 to-teal-400 p-6 md:p-8 lg:p-10 md:flex md:items-center md:justify-between gap-4 md:gap-6 lg:gap-8 animate-fade-up "
            style={{ minHeight: 'clamp(128px, 25vh, 220px)' }}
        >
            {/* Decorative circles */}
            ...
            <div className="relative z-10">
                ...
                <h1 className="text-xl md:text-3xl font-bold text-white m-0">{displayName}</h1>
